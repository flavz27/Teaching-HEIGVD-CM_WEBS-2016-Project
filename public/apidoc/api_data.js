define({ "api": [
  ...
  },
  {
    ...
    "name": "GetIssue",
    "group": "Issues",
    "description": "<p>it's function can get an issue with his id. (can add: /api/issues/:id_issue?embed=user&amp;embed2=comment)</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://localhost/api/issues/4711",
  ...
  },
  {
    ...
    "group": "Issues",
    "description": "<p>get all issues with specific status. You cannot enter something else than [created, acknowledged, assigned, in_progress, solved, rejected]. This will be dealt with on the front-end</p>",
    "examples": [
      {
        "title": "Example usage:",
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "NotFound",
            "description": "<p>There are not issues</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "DataNotValid",
            "description": "<p>The data entered is not authorized</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
  ...
  },
  {
    ...
    "name": "PostUser",
    "group": "Users",
    "description": "<p>This route can create a news user with status staff or not and citizen or not. &quot;citizen&quot;: boolean but if something else is entered, the api will store it as true, same for &quot;staff&quot;</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "http://localhost/api/users",
